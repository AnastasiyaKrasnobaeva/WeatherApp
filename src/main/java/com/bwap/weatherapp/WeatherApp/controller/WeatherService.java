...
public class WeatherService {
    ...
    String unit;
    private String API = "e9d83bb7e90e0c3fd8d5afe515347649";
    ...
    public JSONObject getWeather(){
        ...
        Request request = new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/weather?q="+getCityName()+"&units="+getUnit()+"&appid=e9d83bb7e90e0c3fd8d5afe515347649")
                .build();
